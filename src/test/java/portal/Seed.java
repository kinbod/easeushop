...
import org.networking.repository.GroupRepository;
import org.networking.repository.ResourceRepository;
import org.networking.repository.RoleRepository;
...
public class Seed extends BaseTest {
    ...
    private void userAndRole() throws Exception {
        ...
        User rootAccount = userRepository.findByusername(ROOT);
        ...
        User adminAccount = userRepository.findByusername(ADMIN);
        ...
        User guestAccount = userRepository.findByusername(GUEST);
